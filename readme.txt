...
= 1.5.1 =
* BUGFIX: Disabling Akismet due to all submissions getting flagged as spam.

= 1.5.0 =
* Processing Elementor form submissions with Akismet.

= 1.4.1 =
* Updating `pardot_form_filter()` form name check with `contact us`.

= 1.4.0 =
* Updating `pardot_form_filter()` form name check with `onsite`.
