...
function enqueue_scripts(){
  ...
  wp_register_style( 'slickslider', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css', null, '1.8.1' );
  wp_register_style( 'relatedposts', plugin_dir_url( __FILE__ ) . '../' . NETMIND_CSS_DIR . '/relatedposts.css', [ 'slickslider' ], filemtime(plugin_dir_path( __FILE__ ) . '../' . NETMIND_CSS_DIR . '/relatedposts.css') );
}
